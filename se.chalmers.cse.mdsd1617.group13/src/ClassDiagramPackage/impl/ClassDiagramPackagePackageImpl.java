...
import ClassDiagramPackage.ClassDiagramPackageFactory;
import ClassDiagramPackage.ClassDiagramPackagePackage;
import ClassDiagramPackage.Receptionist;
import ClassDiagramPackage.User;

import ClassDiagramPackage.bankcomponents.BankcomponentsPackage;

import ClassDiagramPackage.bankcomponents.impl.BankcomponentsPackageImpl;

import ClassDiagramPackage.hotelsystem.HotelsystemPackage;

import ClassDiagramPackage.hotelsystem.impl.HotelsystemPackageImpl;
 ...
 * @generated
 */
public class ClassDiagramPackagePackageImpl extends EPackageImpl implements ClassDiagramPackagePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ClassDiagramPackage.ClassDiagramPackagePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ClassDiagramPackagePackageImpl() {
		super(eNS_URI, ClassDiagramPackageFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ClassDiagramPackagePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ClassDiagramPackagePackage init() {
		if (isInited) return (ClassDiagramPackagePackage)EPackage.Registry.INSTANCE.getEPackage(ClassDiagramPackagePackage.eNS_URI);

		// Obtain or create and register package
		ClassDiagramPackagePackageImpl theClassDiagramPackagePackage = (ClassDiagramPackagePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ClassDiagramPackagePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ClassDiagramPackagePackageImpl());
		...
		theClassDiagramPackagePackage.createPackageContents();
		theHotelsystemPackage.createPackageContents();
		theBankcomponentsPackage.createPackageContents();

		// Initialize created meta-data
		theClassDiagramPackagePackage.initializePackageContents();
		theHotelsystemPackage.initializePackageContents();
		theBankcomponentsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theClassDiagramPackagePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ClassDiagramPackagePackage.eNS_URI, theClassDiagramPackagePackage);
		return theClassDiagramPackagePackage;
	}
	 ...
	 * @generated
	 */
	public ClassDiagramPackageFactory getClassDiagramPackageFactory() {
		return (ClassDiagramPackageFactory)getEFactoryInstance();
	}
...
} //ClassDiagramPackagePackageImpl
