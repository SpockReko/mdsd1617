 ...
 * @generated
 */
public class ClassDiagramPackageSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ClassDiagramPackageSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ClassDiagramPackagePackage.USER: {
				User user = (User)theEObject;
				T result = caseUser(user);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ClassDiagramPackagePackage.RECEPTIONIST: {
			...
			case ClassDiagramPackagePackage.ADMINISTRATOR: {
