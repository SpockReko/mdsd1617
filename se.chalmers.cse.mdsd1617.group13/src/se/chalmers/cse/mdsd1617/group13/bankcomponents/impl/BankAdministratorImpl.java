    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case BankcomponentsPackage.BANK_ADMINISTRATOR___MAKE_DEPOSIT__STRING_STRING_INT_INT_STRING_STRING_DOUBLE:
                return makeDeposit((String) arguments.get(0), (String) arguments.get(1), (Integer) arguments.get(2),
                        (Integer) arguments.get(3), (String) arguments.get(4), (String) arguments.get(5),
                        (Double) arguments.get(6));
            case BankcomponentsPackage.BANK_ADMINISTRATOR___ADD_CREDIT_CARD__STRING_STRING_INT_INT_STRING_STRING:
                return addCreditCard((String) arguments.get(0), (String) arguments.get(1), (Integer) arguments.get(2),
                        (Integer) arguments.get(3), (String) arguments.get(4), (String) arguments.get(5));
            case BankcomponentsPackage.BANK_ADMINISTRATOR___REMOVE_CREDIT_CARD__STRING_STRING_INT_INT_STRING_STRING:
                return removeCreditCard((String) arguments.get(0), (String) arguments.get(1),
            ...
            case BankcomponentsPackage.BANK_ADMINISTRATOR___GET_BALANCE__STRING_STRING_INT_INT_STRING_STRING:
                return getBalance((String) arguments.get(0), (String) arguments.get(1), (Integer) arguments.get(2),
                        (Integer) arguments.get(3), (String) arguments.get(4), (String) arguments.get(5));
        }
