 ...
 * </p>
 * <ul>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.BookingHandlerImpl#getBookings <em>Bookings</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.BookingHandlerImpl#getPaymentHandler <em>Payment Handler</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.BookingHandlerImpl#getRoomhandler <em>Roomhandler</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.BookingHandlerImpl#getBookingCurrentlyCheckingOut <em>Booking Currently Checking Out</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.BookingHandlerImpl#getNextBookingId <em>Next Booking Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BookingHandlerImpl extends MinimalEObjectImpl.Container implements BookingHandler {
	...
	protected EClass eStaticClass() {
		return ZPackage.Literals.BOOKING_HANDLER;
	}
	...
	public EList<Booking> getBookings() {
		if (bookings == null) {
			bookings = new EObjectResolvingEList<Booking>(Booking.class, this, ZPackage.BOOKING_HANDLER__BOOKINGS);
		}
		return bookings;
	}
		...
		if (paymentHandler != null && paymentHandler.eIsProxy()) {
			...
			if (paymentHandler != oldPaymentHandler) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ZPackage.BOOKING_HANDLER__PAYMENT_HANDLER, oldPaymentHandler, paymentHandler));
			}
		}
	...
	public void setPaymentHandler(PaymentHandler newPaymentHandler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.BOOKING_HANDLER__PAYMENT_HANDLER, oldPaymentHandler, paymentHandler));
	}
	...
	public IRoomHandler getRoomhandler() {
		if (roomhandler != null && roomhandler.eIsProxy()) {
			...
			if (roomhandler != oldRoomhandler) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ZPackage.BOOKING_HANDLER__ROOMHANDLER, oldRoomhandler, roomhandler));
			}
		}
		return roomhandler;
	}
	...
	public void setRoomhandler(IRoomHandler newRoomhandler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.BOOKING_HANDLER__ROOMHANDLER, oldRoomhandler, roomhandler));
	}
	...
	public void setBookingCurrentlyCheckingOut(int newBookingCurrentlyCheckingOut) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.BOOKING_HANDLER__BOOKING_CURRENTLY_CHECKING_OUT, oldBookingCurrentlyCheckingOut, bookingCurrentlyCheckingOut));
	}
	...
	public void setNextBookingId(int newNextBookingId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.BOOKING_HANDLER__NEXT_BOOKING_ID, oldNextBookingId, nextBookingId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ZPackage.BOOKING_HANDLER__BOOKINGS:
				return getBookings();
			case ZPackage.BOOKING_HANDLER__PAYMENT_HANDLER:
				if (resolve) return getPaymentHandler();
				return basicGetPaymentHandler();
			case ZPackage.BOOKING_HANDLER__ROOMHANDLER:
				if (resolve) return getRoomhandler();
				return basicGetRoomhandler();
			case ZPackage.BOOKING_HANDLER__BOOKING_CURRENTLY_CHECKING_OUT:
				return getBookingCurrentlyCheckingOut();
			case ZPackage.BOOKING_HANDLER__NEXT_BOOKING_ID:
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == IHotelCustomerProvides.class) {
			switch (baseOperationID) {
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___GET_FREE_ROOMS__INT_STRING_STRING: return ZPackage.BOOKING_HANDLER___GET_FREE_ROOMS__INT_STRING_STRING;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___INITIATE_BOOKING__STRING_STRING_STRING_STRING: return ZPackage.BOOKING_HANDLER___INITIATE_BOOKING__STRING_STRING_STRING_STRING;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___ADD_ROOM_TO_BOOKING__STRING_INT: return ZPackage.BOOKING_HANDLER___ADD_ROOM_TO_BOOKING__STRING_INT;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___CONFIRM_BOOKING__INT: return ZPackage.BOOKING_HANDLER___CONFIRM_BOOKING__INT;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___INITIATE_CHECKOUT__INT: return ZPackage.BOOKING_HANDLER___INITIATE_CHECKOUT__INT;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___PAY_DURING_CHECKOUT__STRING_STRING_INT_INT_STRING_STRING: return ZPackage.BOOKING_HANDLER___PAY_DURING_CHECKOUT__STRING_STRING_INT_INT_STRING_STRING;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___INITIATE_ROOM_CHECKOUT__INT_INT: return ZPackage.BOOKING_HANDLER___INITIATE_ROOM_CHECKOUT__INT_INT;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___PAY_ROOM_DURING_CHECKOUT__INT_STRING_STRING_INT_INT_STRING_STRING: return ZPackage.BOOKING_HANDLER___PAY_ROOM_DURING_CHECKOUT__INT_STRING_STRING_INT_INT_STRING_STRING;
				case ZPackage.IHOTEL_CUSTOMER_PROVIDES___CHECK_IN_ROOM__STRING_INT: return ZPackage.BOOKING_HANDLER___CHECK_IN_ROOM__STRING_INT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ZPackage.BOOKING_HANDLER___INITIATE_ROOM_CHECKOUT__INT_INT:
				return initiateRoomCheckout((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ZPackage.BOOKING_HANDLER___PAY_ROOM_DURING_CHECKOUT__INT_STRING_STRING_INT_INT_STRING_STRING:
			...
			case ZPackage.BOOKING_HANDLER___CHECK_IN_ROOM__STRING_INT:
				return checkInRoom((String)arguments.get(0), (Integer)arguments.get(1));
			case ZPackage.BOOKING_HANDLER___BOOKING_CHECKIN__STRING:
				return bookingCheckin((String)arguments.get(0));
			case ZPackage.BOOKING_HANDLER___ADD_DAY__STRING:
				return addDay((String)arguments.get(0));
			case ZPackage.BOOKING_HANDLER___GET_BOOKING_BY_ID__INT:
				return getBookingById((Integer)arguments.get(0));
			case ZPackage.BOOKING_HANDLER___IS_FREE__INT_STRING_STRING:
