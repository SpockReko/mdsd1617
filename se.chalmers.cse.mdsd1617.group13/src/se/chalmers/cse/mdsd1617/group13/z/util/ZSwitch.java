...
public class ZSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ZPackage.IHOTEL_ADMINISTRATOR_PROVIDES: {
			...
			case ZPackage.IHOTEL_STARTUP_PROVIDES: {
			...
			case ZPackage.HOTEL_INITIALIZER: {
			...
			case ZPackage.IHOTEL_RECEPTIONIST_PROVIDES: {
