 ...
 * </p>
 * <ul>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.RoomTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.RoomTypeImpl#getNumBeds <em>Num Beds</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.RoomTypeImpl#getPricePerNight <em>Price Per Night</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.RoomTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomTypeImpl extends MinimalEObjectImpl.Container implements RoomType {
	...
	protected EClass eStaticClass() {
		return ZPackage.Literals.ROOM_TYPE;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.ROOM_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setNumBeds(int newNumBeds) {
		...
		numBeds = newNumBeds;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.ROOM_TYPE__NUM_BEDS, oldNumBeds, numBeds));
	}
	...
	public void setPricePerNight(double newPricePerNight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.ROOM_TYPE__PRICE_PER_NIGHT, oldPricePerNight, pricePerNight));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.ROOM_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ZPackage.ROOM_TYPE__DESCRIPTION:
				return getDescription();
			case ZPackage.ROOM_TYPE__NUM_BEDS:
				return getNumBeds();
			case ZPackage.ROOM_TYPE__PRICE_PER_NIGHT:
				return getPricePerNight();
			case ZPackage.ROOM_TYPE__NAME:
				return getName();
		}
