 ...
 * </p>
 * <ul>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.FreeRoomTypesDTOImpl#getRoomTypeDescription <em>Room Type Description</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.FreeRoomTypesDTOImpl#getNumBeds <em>Num Beds</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.FreeRoomTypesDTOImpl#getPricePerNight <em>Price Per Night</em>}</li>
 *   <li>{@link se.chalmers.cse.mdsd1617.group13.z.impl.FreeRoomTypesDTOImpl#getNumFreeRooms <em>Num Free Rooms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FreeRoomTypesDTOImpl extends MinimalEObjectImpl.Container implements FreeRoomTypesDTO {
	...
	protected EClass eStaticClass() {
		return ZPackage.Literals.FREE_ROOM_TYPES_DTO;
	}
	...
	public void setRoomTypeDescription(String newRoomTypeDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.FREE_ROOM_TYPES_DTO__ROOM_TYPE_DESCRIPTION, oldRoomTypeDescription, roomTypeDescription));
	}
	...
	public void setNumBeds(int newNumBeds) {
		...
		numBeds = newNumBeds;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.FREE_ROOM_TYPES_DTO__NUM_BEDS, oldNumBeds, numBeds));
	}
	...
	public void setPricePerNight(double newPricePerNight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.FREE_ROOM_TYPES_DTO__PRICE_PER_NIGHT, oldPricePerNight, pricePerNight));
	}
	...
	public void setNumFreeRooms(int newNumFreeRooms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPackage.FREE_ROOM_TYPES_DTO__NUM_FREE_ROOMS, oldNumFreeRooms, numFreeRooms));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ZPackage.FREE_ROOM_TYPES_DTO__ROOM_TYPE_DESCRIPTION:
				return getRoomTypeDescription();
			case ZPackage.FREE_ROOM_TYPES_DTO__NUM_BEDS:
				return getNumBeds();
			case ZPackage.FREE_ROOM_TYPES_DTO__PRICE_PER_NIGHT:
				return getPricePerNight();
			case ZPackage.FREE_ROOM_TYPES_DTO__NUM_FREE_ROOMS:
