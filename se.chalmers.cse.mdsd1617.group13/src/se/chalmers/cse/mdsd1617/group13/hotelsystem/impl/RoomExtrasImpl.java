...
public class RoomExtrasImpl extends MinimalEObjectImpl.Container implements RoomExtras {
	...
	protected EClass eStaticClass() {
		return HotelsystemPackage.Literals.ROOM_EXTRAS;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_EXTRAS__DESCRIPTION, oldDescription, description));
	}
