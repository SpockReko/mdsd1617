...
public class PaymentHandlerImpl extends MinimalEObjectImpl.Container implements PaymentHandler {
            ...
            if (bankingComponent != oldBankingComponent) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            HotelsystemPackage.PAYMENT_HANDLER__BANKING_COMPONENT, oldBankingComponent,
                            bankingComponent));
            }
        }
    ...
    public void setBankingComponent(ICustomerProvides newBankingComponent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.PAYMENT_HANDLER__BANKING_COMPONENT,
                    oldBankingComponent, bankingComponent));
    }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case HotelsystemPackage.PAYMENT_HANDLER___PAY_IF_CARD_VALID__STRING_STRING_INT_INT_STRING_STRING_DOUBLE:
                return payIfCardValid((String) arguments.get(0), (String) arguments.get(1), (Integer) arguments.get(2),
