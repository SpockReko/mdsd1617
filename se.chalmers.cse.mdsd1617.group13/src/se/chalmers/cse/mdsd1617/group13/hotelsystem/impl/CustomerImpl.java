...
public class CustomerImpl extends MinimalEObjectImpl.Container implements Customer {
    ...
    public void setFirstName(String newFirstName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.CUSTOMER__FIRST_NAME, oldFirstName,
                    firstName));
    }
    ...
    public void setLastName(String newLastName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.CUSTOMER__LAST_NAME, oldLastName,
                    lastName));
    }
