...
public class FreeRoomTypesDTOImpl extends MinimalEObjectImpl.Container implements FreeRoomTypesDTO {
    ...
    public void setRoomTypeDescription(String newRoomTypeDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    HotelsystemPackage.FREE_ROOM_TYPES_DTO__ROOM_TYPE_DESCRIPTION, oldRoomTypeDescription,
                    roomTypeDescription));
    }
    ...
    public void setNumBeds(int newNumBeds) {
        ...
        numBeds = newNumBeds;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.FREE_ROOM_TYPES_DTO__NUM_BEDS,
                    oldNumBeds, numBeds));
    }
    ...
    public void setPricePerNight(double newPricePerNight) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    HotelsystemPackage.FREE_ROOM_TYPES_DTO__PRICE_PER_NIGHT, oldPricePerNight, pricePerNight));
    }
    ...
    public void setNumFreeRooms(int newNumFreeRooms) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    HotelsystemPackage.FREE_ROOM_TYPES_DTO__NUM_FREE_ROOMS, oldNumFreeRooms, numFreeRooms));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case HotelsystemPackage.FREE_ROOM_TYPES_DTO__ROOM_TYPE_DESCRIPTION:
                return ROOM_TYPE_DESCRIPTION_EDEFAULT == null ? roomTypeDescription != null : !ROOM_TYPE_DESCRIPTION_EDEFAULT.equals(
                        roomTypeDescription);
            case HotelsystemPackage.FREE_ROOM_TYPES_DTO__NUM_BEDS:
