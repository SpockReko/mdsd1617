 ...
 * <li>{@link se.chalmers.cse.mdsd1617.group13.hotelsystem.impl.RoomReservationImpl#getCheckOuDate <em>Check Ou Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomReservationImpl extends MinimalEObjectImpl.Container implements RoomReservation {
            ...
            if (roomType != oldRoomType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            HotelsystemPackage.ROOM_RESERVATION__ROOM_TYPE, oldRoomType, roomType));
            }
        }
        return roomType;
    }
    ...
    public void setRoomType(RoomType newRoomType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_RESERVATION__ROOM_TYPE,
    ...
    public EList<RoomExtra> getRoomExtras() {
        if (roomExtras == null) {
            roomExtras = new EObjectResolvingEList<RoomExtra>(RoomExtra.class, this,
                    HotelsystemPackage.ROOM_RESERVATION__ROOM_EXTRAS);
        }
        return roomExtras;
    }
    ...
    public void setStartDate(String newStartDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_RESERVATION__START_DATE,
    ...
    public void setEndDate(String newEndDate) {
        ...
        endDate = newEndDate;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_RESERVATION__END_DATE,
                    oldEndDate, endDate));
    }
    ...
    public Room getRoom() {
        if (room != null && room.eIsProxy()) {
            ...
            if (room != oldRoom) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, HotelsystemPackage.ROOM_RESERVATION__ROOM,
                            oldRoom, room));
            }
        }
        return room;
    ...
    public void setRoom(Room newRoom) {
        ...
        room = newRoom;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_RESERVATION__ROOM, oldRoom,
                    room));
    }
    ...
    public void setCheckInDate(String newCheckInDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_RESERVATION__CHECK_IN_DATE,
    ...
    public void setCheckOuDate(String newCheckOuDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_RESERVATION__CHECK_OU_DATE,
                    oldCheckOuDate, checkOuDate));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case HotelsystemPackage.ROOM_RESERVATION__CHECK_OU_DATE:
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case HotelsystemPackage.ROOM_RESERVATION__ROOM:
                return room != null;
            case HotelsystemPackage.ROOM_RESERVATION__CHECK_IN_DATE:
                return CHECK_IN_DATE_EDEFAULT == null ? checkInDate != null : !CHECK_IN_DATE_EDEFAULT.equals(
                        checkInDate);
            case HotelsystemPackage.ROOM_RESERVATION__CHECK_OU_DATE:
                return CHECK_OU_DATE_EDEFAULT == null ? checkOuDate != null : !CHECK_OU_DATE_EDEFAULT.equals(
                        checkOuDate);
        }
