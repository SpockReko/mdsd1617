...
public class RoomExtraImpl extends MinimalEObjectImpl.Container implements RoomExtra {
	...
	protected EClass eStaticClass() {
		return HotelsystemPackage.Literals.ROOM_EXTRA;
	}
	...
	public void setPrice(double newPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_EXTRA__PRICE, oldPrice, price));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_EXTRA__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HotelsystemPackage.ROOM_EXTRA__PRICE:
				return getPrice();
			case HotelsystemPackage.ROOM_EXTRA__DESCRIPTION:
