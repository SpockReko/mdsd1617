...
public class RoomExtraImpl extends MinimalEObjectImpl.Container implements RoomExtra {
    ...
    public void setPrice(double newPrice) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_EXTRA__PRICE, oldPrice,
                    price));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.ROOM_EXTRA__DESCRIPTION,
