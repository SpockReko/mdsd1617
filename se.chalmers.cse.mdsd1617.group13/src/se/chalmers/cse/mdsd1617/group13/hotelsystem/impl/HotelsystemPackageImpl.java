...
public class HotelsystemPackageImpl extends EPackageImpl implements HotelsystemPackage {
	 ...
	 * @generated
	 */
	public EAttribute getRoomReservation_CheckIn() {
	 ...
	 * @generated
	 */
	public EOperation getRoomHandler__GetRoomType__String() {
	...
	public void createPackageContents() {
		...
		createEAttribute(roomReservationEClass, ROOM_RESERVATION__CHECK_IN);
		...
		createEOperation(roomHandlerEClass, ROOM_HANDLER___GET_ROOM_TYPE__STRING);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRoomReservation_CheckIn(), ecorePackage.getEString(), "checkIn", null, 1, 1, RoomReservation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		op = initEOperation(getRoomHandler__GetRoomType__String(), this.getRoomType(), "getRoomType", 1, 1, IS_UNIQUE, !IS_ORDERED);
