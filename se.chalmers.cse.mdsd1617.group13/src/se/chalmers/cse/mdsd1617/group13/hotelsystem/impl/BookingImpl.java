...
public class BookingImpl extends MinimalEObjectImpl.Container implements Booking {
        ...
        if (customer != null && customer.eIsProxy()) {
            ...
            if (customer != oldCustomer) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, HotelsystemPackage.BOOKING__CUSTOMER,
    ...
    public void setCustomer(Customer newCustomer) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.BOOKING__CUSTOMER, oldCustomer,
                    customer));
    }
    ...
    public EList<RoomReservation> getRoomReservations() {
        if (roomReservations == null) {
            roomReservations = new EObjectResolvingEList<RoomReservation>(RoomReservation.class, this,
                    HotelsystemPackage.BOOKING__ROOM_RESERVATIONS);
        }
    ...
    public void setStartDate(String newStartDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.BOOKING__START_DATE, oldStartDate,
                    startDate));
    }
    ...
    public void setEndDate(String newEndDate) {
        ...
        endDate = newEndDate;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.BOOKING__END_DATE, oldEndDate,
                    endDate));
    }
    ...
    public void setCanceled(boolean newCanceled) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.BOOKING__CANCELED, oldCanceled,
                    canceled));
    }
    ...
    public void setBookingId(int newBookingId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.BOOKING__BOOKING_ID, oldBookingId,
                    bookingId));
    }
    ...
    public void setConfirmed(boolean newConfirmed) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, HotelsystemPackage.BOOKING__CONFIRMED, oldConfirmed,
                    confirmed));
    }
