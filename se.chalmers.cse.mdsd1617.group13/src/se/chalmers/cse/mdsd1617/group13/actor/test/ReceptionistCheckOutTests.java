...
/*	@Test
    ...
    public void testCheckoutAndPayRightCard() {
        receptionist.getIhotelcustomerprovides().initiateCheckout(1);
        boolean result = receptionist.getIhotelcustomerprovides().payDuringCheckout("00000000", "000", 11, 16, "Peter",
                "Pan");
        assertEquals(result, true);
    }
    ...
    public void testCheckoutAndPayWrongCard() {
        receptionist.getIhotelcustomerprovides().initiateCheckout(1);
        boolean result = receptionist.getIhotelcustomerprovides().payDuringCheckout("00000", "000", 11, 16, "Peter",
                "Pan");
