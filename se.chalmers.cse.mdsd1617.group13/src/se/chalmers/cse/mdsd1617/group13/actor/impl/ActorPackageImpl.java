...
public class ActorPackageImpl extends EPackageImpl implements ActorPackage {
    ...
    public static ActorPackage init() {
        ...
        ActorPackageImpl theActorPackage = (ActorPackageImpl) (EPackage.Registry.INSTANCE.get(
                eNS_URI) instanceof ActorPackageImpl ? EPackage.Registry.INSTANCE.get(
                eNS_URI) : new ActorPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        HotelsystemPackage theHotelsystemPackage = (HotelsystemPackage) EPackage.Registry.INSTANCE.getEPackage(
                HotelsystemPackage.eNS_URI);
        ...
        initEReference(getReceptionist_Ireceptionistprovides(), theHotelsystemPackage.getIHotelReceptionistProvides(),
                null, "ireceptionistprovides", null, 1, 1, Receptionist.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getReceptionist_Ihotelcustomerprovides(), theHotelsystemPackage.getIHotelCustomerProvides(),
                null, "ihotelcustomerprovides", null, 1, 1, Receptionist.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(administratorEClass, Administrator.class, "Administrator", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getAdministrator_Iadministratorprovides(),
                theHotelsystemPackage.getIHotelAdministratorProvides(), null, "iadministratorprovides", null, 1, 1,
                Administrator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getAdministrator_Ihotelstartupprovides(), theHotelsystemPackage.getIHotelStartupProvides(), null,
                "ihotelstartupprovides", null, 1, 1, Administrator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
